(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Clappr"] = factory(require("hls.js"));
	else
		root["Clappr"] = factory(root["Hls"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_hlsjs__) {
...
var _hlsjs = __webpack_require__(/*! hlsjs */ "hlsjs");
...
var HLS = function (_HTML5VideoPlayback) {
  ...
  HLS.prototype._setup = function _setup() {
    ...
    this._hls = new _hlsjs2.default((0, _utils.assign)({}, this.options.playback.hlsjsConfig));
    this._hls.on(_hlsjs2.default.Events.MEDIA_ATTACHED, function () {
      return _this2._hls.loadSource(_this2.options.src);
    });
    this._hls.on(_hlsjs2.default.Events.LEVEL_LOADED, function (evt, data) {
      return _this2._updatePlaybackType(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.LEVEL_UPDATED, function (evt, data) {
      return _this2._onLevelUpdated(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.LEVEL_SWITCHING, function (evt, data) {
      return _this2._onLevelSwitch(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.FRAG_LOADED, function (evt, data) {
      return _this2._onFragmentLoaded(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.ERROR, function (evt, data) {
      return _this2._onHLSJSError(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.SUBTITLE_TRACK_LOADED, function (evt, data) {
      return _this2._onSubtitleLoaded(evt, data);
    });
    this._hls.on(_hlsjs2.default.Events.SUBTITLE_TRACKS_UPDATED, function () {
  ...
  HLS.prototype._onHLSJSError = function _onHLSJSError(evt, data) {
    ...
    if (data.fatal) {
      if (this._recoverAttemptsRemaining > 0) {
        ...
        switch (data.type) {
          case _hlsjs2.default.ErrorTypes.NETWORK_ERROR:
            switch (data.details) {
              // The following network errors cannot be recovered with HLS.startLoad()
              // For more details, see https://github.com/video-dev/hls.js/blob/master/doc/design.md#error-detection-and-handling
              // For "level load" fatal errors, see https://github.com/video-dev/hls.js/issues/1138
              case _hlsjs2.default.ErrorDetails.MANIFEST_LOAD_ERROR:
              case _hlsjs2.default.ErrorDetails.MANIFEST_LOAD_TIMEOUT:
              case _hlsjs2.default.ErrorDetails.MANIFEST_PARSING_ERROR:
              case _hlsjs2.default.ErrorDetails.LEVEL_LOAD_ERROR:
              case _hlsjs2.default.ErrorDetails.LEVEL_LOAD_TIMEOUT:
            ...
            break;
          case _hlsjs2.default.ErrorTypes.MEDIA_ERROR:
  ...
  HLS.prototype._keyIsDenied = function _keyIsDenied(data) {
    return data.type === _hlsjs2.default.ErrorTypes.NETWORK_ERROR && data.details === _hlsjs2.default.ErrorDetails.KEY_LOAD_ERROR && data.response && data.response.code >= 400;
  };
...
HLS.canPlay = function (resource, mimeType) {
  ...
  return !!(_hlsjs2.default.isSupported() && isHls);
};
module.exports = exports['default'];
...
module.exports = __WEBPACK_EXTERNAL_MODULE_hlsjs__;
